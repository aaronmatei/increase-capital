...
(function(e, t) {
	...
	var n = e.document,
		...
		o = n.createElementNS("http://www.w3.org/1999/xhtml", "a"),
		i = "download" in o,
		a = function(e) {
			var t = new MouseEvent("click");
			e.dispatchEvent(t);
		},
		f = /constructor/i.test(e.HTMLElement) || e.safari,
				...
				S = function() {
					if ((u || (v && f)) && e.FileReader) {
						...
						n.onloadend = function() {
							var t = u ? n.result : n.result.replace(/^data:[^;]*;/, "data:attachment/file;");
							var r = e.open(t, "_blank");
							if (!r) e.location.href = t;
							t = undefined;
							s.readyState = s.DONE;
							h();
						};
